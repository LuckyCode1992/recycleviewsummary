package com.recycleview.smartrefresh.layout;
...
import com.recycleview.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.recycleview.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.recycleview.smartrefresh.layout.api.DefaultRefreshInitializer;
import com.recycleview.smartrefresh.layout.api.RefreshContent;
import com.recycleview.smartrefresh.layout.api.RefreshFooter;
import com.recycleview.smartrefresh.layout.api.RefreshHeader;
import com.recycleview.smartrefresh.layout.api.RefreshInternal;
import com.recycleview.smartrefresh.layout.api.RefreshKernel;
import com.recycleview.smartrefresh.layout.api.RefreshLayout;
import com.recycleview.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.recycleview.smartrefresh.layout.constant.DimensionStatus;
import com.recycleview.smartrefresh.layout.constant.RefreshState;
import com.recycleview.smartrefresh.layout.constant.SpinnerStyle;
import com.recycleview.smartrefresh.layout.footer.BallPulseFooter;
import com.recycleview.smartrefresh.layout.header.BezierRadarHeader;
import com.recycleview.smartrefresh.layout.impl.RefreshContentWrapper;
import com.recycleview.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.recycleview.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.recycleview.smartrefresh.layout.listener.OnLoadMoreListener;
import com.recycleview.smartrefresh.layout.listener.OnMultiPurposeListener;
...
import com.recycleview.smartrefresh.layout.listener.OnStateChangedListener;
import com.recycleview.smartrefresh.layout.util.DelayedRunnable;
import com.recycleview.smartrefresh.layout.util.DensityUtil;
import com.recycleview.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.recycleview.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.recycleview.smartrefresh.layout.util.SmartUtil.fling;
import static com.recycleview.smartrefresh.layout.util.SmartUtil.getColor;
import static com.recycleview.smartrefresh.layout.util.SmartUtil.isContentView;
...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.recycleview.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.recycleview.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
